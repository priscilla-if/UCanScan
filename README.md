...
```
cd existing_repo
git remote add origin https://eng-git.canterbury.ac.nz/pis19/seng440-assignment-2.git
git branch -M main
...
- [ ] [Set up project integrations](https://eng-git.canterbury.ac.nz/pis19/seng440-assignment-2/-/settings/integrations)
